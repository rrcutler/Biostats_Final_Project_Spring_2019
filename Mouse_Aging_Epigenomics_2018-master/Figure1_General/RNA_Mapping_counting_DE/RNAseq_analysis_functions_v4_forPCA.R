...
process_aging_rnaseq <- function(my.tissue, my.matrix, reps.3=3, reps.12=3, reps.29=3) {
  ...
  pdf(my.mds.out)
  plot(x, y, xlab = "MDS dimension 1", ylab = "MDS dimension 2",main="Multi-dimensional Scaling",cex=2,pch = 6)
  points(x,y, pch = 25, cex=3, col=NA ,bg=my.colors)
